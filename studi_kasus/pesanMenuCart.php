...
$id = $_GET['id'];
$query = mysqli_query($connection, "SELECT * FROM tcart WHERE id='$id'");
?>
                            ...
                            <form action="storePesanan.php" method="POST">
                                ...
                                ?>
                                    <table cellpadding="8" class="w-100">
                                        ...
                                        <tr>
                                            <td>quantity</td>
                                            <td><input class="form-control" type="text" name="quantity" size="20" placeholder="jumlah barang yang dipesan " required value="<?= $row['quantity'] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Note</td>
