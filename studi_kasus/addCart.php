...
<body>
  ...
  <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="text-left mb-4">Add to Cart</h2> 
            <div class="card">
                <div class="card-body">
                    <!-- Form -->
                    <form action="storeCart.php" method="POST" enctype="multipart/form-data">
                        <?php
                        ...
                        ?>
                            <table cellpadding="8" class="w-100">
                                ...
                                <tr>
                                    <td>Gambar Produk</td>
                                    <td>
                                        <img src="assets/gambar/<?= $row['foto'] ?>" alt="Gambar Produk" width="200">
                                ...
                                <tr>
                                    <td>quantity</td>
                                    <td><input class="form-control" type="number" name="quantity" size="20" placeholder="jumlah barang yang dipesan " required></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input class="btn btn-success d-inline" type="submit" name="proses" value="Add to cart">
